...
def upgrade():
    ...
    op.create_table('api_endpoint_config',
    ...
    with op.batch_alter_table('api_endpoint_config', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_api_endpoint_config_api_url'), ['api_url'], unique=True)
    ...
    with op.batch_alter_table('api_model', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_api_model_api_url'), ['api_url'], unique=False)

    op.create_table('generation_template',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('type', sa.Enum('CREATE_SUBDEADDIT', 'CREATE_USER', 'CREATE_POST', 'CREATE_COMMENT', 'BATCH_OPERATION', 'SCHEDULED_TASK', 'CONTENT_CLEANUP', name='jobtype'), nullable=False),
    ...
    with op.batch_alter_table('job', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_job_rq_job_id'), ['rq_job_id'], unique=True)
    ...
    with op.batch_alter_table('post', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_post_subdeaddit_name'), ['subdeaddit_name'], unique=False)
    ...
    with op.batch_alter_table('comment', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_comment_upvote_count'), ['upvote_count'], unique=False)
