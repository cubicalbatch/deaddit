...
| AgenticCore P0+1 | LeadAC01 | **in_progress** | — | — | Consumes services/content.py signatures (A4 row); ensure_tools_allowed(auto_probe=True) at creation; feature-flag OFF (decision 1); live run-once verdict required |
| UX-2 feed reading experience | LeadUX23 | **in_progress** | — | — | Serial pair inside LeadUX23: UX-2 PASS+commit then UX-3 |
| UX-3 CommentTree rebuild | LeadUX23 | **in_progress** | — | — | Second leg of LeadUX23 |
| LLM-3 accounting + routing | LeadLLM3 | **in_progress** | — | — | LLMUsage around client.complete(); ModelRoute replaces substring matching + MODELS global |
