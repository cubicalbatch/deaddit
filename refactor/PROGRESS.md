...
| D1 votes/karma/backfill | LeadD1 | **in_progress** | — | — | Vote table + cast_vote contract; exact-sum backfill w/ source='backfill'; nightly recompute via runtime.nightly; prod snapshot before DDL |
| UX-4 profiles/people/setup/search | LeadUX4 | **in_progress** | — | — | Wave 4 parallel lane; SQLite site search (decision 10); users_list NULL-bio crash fix lands here |
