...
register(
    Tool(
        ...
        description=(
            ...
            "information architecture, visual language, concrete content, "
            "interactions, and the specific rendered page. Keep the brief "
            "focused: the generator has a finite output budget, so a modest "
            "site with a few well-crafted sections and a small set of real "
            "content items is far more likely to succeed than an exhaustive "
            "one. Deliberately choose a distinctive site structure, navigation "
            "pattern, visual mood, and typographic character rather than "
            "defaulting to a document-like artifact. The technical deliverable "
            "is one self-contained HTML file, but the visible design may "
            "include multiple sections, navigation, menus, and a footer. "
            "hostname_hint and page_name_hint are fitting fictional URL hints "
            "and may be adjusted to meet storage rules."
        ),
